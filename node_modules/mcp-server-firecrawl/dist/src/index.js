...
if (!FIRE_CRAWL_API_URL && !FIRE_CRAWL_API_KEY) {
    console.error('Error: FIRE_CRAWL_API_KEY environment variable is required when using the cloud service');
    process.exit(1);
}
...
const CONFIG = {
    ...
    credit: {
        warningThreshold: Number(process.env.FIRE_CRAWL_CREDIT_WARNING_THRESHOLD) || 1000,
        criticalThreshold: Number(process.env.FIRE_CRAWL_CREDIT_CRITICAL_THRESHOLD) || 100,
    },
};
const creditUsage = {
    total: 0,
...
${operation.result
            ...
            case 'fire_crawl_check_crawl_status': {
                if (!isStatusCheckOptions(args)) {
                    throw new Error('Invalid arguments for fire_crawl_check_crawl_status');
                }
